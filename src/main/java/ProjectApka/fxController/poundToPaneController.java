    ...
    public void initialize() {
        toUncjaButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try {
                    VBox mainPane = FXMLLoader.load(getClass().getResource("/fxml/giveNumberPoundsToUncjaPane.fxml"));
        ...
        toKgButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try {
                    VBox mainPane = FXMLLoader.load(getClass().getResource("/fxml/giveNumberPoundsToKgPane.fxml"));
                    Scene scene = new Scene (mainPane);
                stage.setScene (scene);
